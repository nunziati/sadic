...
def process_protein(input_arg, vdw_radii = None, resolution = 0.3, method=None, verbose=True, single_methods=None):
    if single_methods is None:
        single_methods = dict(
            ...
            indexes_computation_method = "kd_trees_scipy_tree_comparison" # kd_trees_scipy_tree_comparison" # "kd_trees_scipy_tree_comparison translated_sphere_vectorized"
        )
    ...
    np.save(f"{indexes_computation_method}_idx.npy", result)
